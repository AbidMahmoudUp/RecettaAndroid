...
//
//@Composable
//fun ProfileScreen(navController: NavController, data : LoginResponse?) {
...
//    val call = RetrofitInstance.api.getUserData(UpdateUserDto(data?.userId.toString()))
//
...
//    })
//    if (dataLoaded){
//        profileSettingsSection(context, navController, userData , data)
//    }
//
//
//}
...
//
//@Composable
//private fun DeleteAccountSection(data: LoginResponse? , navController: NavController ,context: Context) {
...
//            editor.apply()
//
//            val call = RetrofitInstance.api.deleteAccount(UpdateUserDto(data?.userId.toString()))
//
...
//    }
//        ,
//        colors = ButtonColors(Color(0xFFBF360C) ,Color.White ,Color(0xFFBF360C),Color(0xFFBF360C))
//    ){
//        Text(
//            text = "Confirm",
